"""Environment registry — single source of truth for Atari experiment (Experiment 3)."""
...
ENV_ORDER: list[str] = ["Pong", "Breakout", "Seaquest"]
...
N_SEEDS: int = 10
MASTER_SEED: int = (
    20260301  # different from Experiment 1's 20260212 and Experiment 2's 20260215
)
